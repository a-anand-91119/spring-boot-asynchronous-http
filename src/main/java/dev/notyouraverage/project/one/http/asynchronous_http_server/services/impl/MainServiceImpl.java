...
public class MainServiceImpl implements MainService {
    ...
    public MainServiceImpl(
            ...
            BlockRequestHelper blockRequestHelper,
            ProcessedRequestDataTransformer processedRequestDataTransformer
    ) {
    ...
    public ProcessedRequestResponse processRequest(String requestId, @NotBlank String name) {
        ...
        try {
            ...
            return processedRequestDataTransformer
                    .convertToProcessedRequestResponse(blockRequestHelper.removeResponsePayload(requestId));
